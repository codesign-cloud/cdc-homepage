      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="px-8 py-10 overflow-hidden lg:px-24 md:py-20 bg-gray-50 rounded-3xl">
          <div className="max-w-lg mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">You’re ready to get started</h2>
          </div>
          ...
          <ul className="flex flex-col items-center justify-center mt-8 space-y-5 sm:mt-12 lg:mt-16 md:flex-row md:space-y-0 md:space-x-12">
            <li className="flex items-center text-gray-900">
              ...
              <span className="ml-3 text-lg font-bold font-pj"> Next.js </span>
            </li>
            ...
            <li className="flex items-center text-gray-900">
              ...
              <span className="ml-3 text-lg font-bold font-pj"> Tailwind CSS </span>
            </li>
            ...
            <li className="flex items-center text-gray-900">
              ...
              <span className="ml-3 text-lg font-bold font-pj"> TypeScript </span>
            </li>
          </ul>
